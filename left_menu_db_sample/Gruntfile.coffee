  ...
  grunt.initConfig
    ...
    connect:
        ...
        sauce:  # Used by sauce tasks, see https://wiki.saucelabs.com/display/DOCS/Grunt-Saucelabs+Set+Up%2C+Configuration%2C+and+Usage
            options:
                # hostname: "itfactoryddns.iptime.org:5432"
                # hostname: "127.0.0.1"
                # port: 8080
                port: 9999
                base: ""
                keepalive: false
        itfactoryddns.iptime.org:5432_9999:  # Start web server for Sauce live testing w/ manuallly run bin/sc.exe
            options:
                # hostname: "itfactoryddns.iptime.org:5432"
                port: 9999
                base: ""
...
#               optimization: 10
    ...
    qunit:
        options:
            httpBase: "http://itfactoryddns.iptime.org:5432:8080"
    ...
    "saucelabs-qunit":
        options:
            ...
            tunnelArgs: [
              ...
              '--tunnel-domains', 'itfactoryddns.iptime.org:5432,travis.dev'
        ...
        triage:
            options:
                ...
                urls: ["http://itfactoryddns.iptime.org:5432:9999/test/unit/test-core.html"]
        ...
        beta:  # This tests are allowed to fail in the travis matrix
            options:
                ...
                browsers: [
                  ...
                  # 2019-06-02: known problem with Saucelabs using itfactoryddns.iptime.org:5432 on macOS:
                  { browserName: "safari", version: "12", platform: "macOS 10.14" }

    ...
    <div class="container-fluid full-width-container value-added-detail-page">
		<div>
			<div class="pull-right table-title-top-action">
				...
				<button type="button" onclick="location.href='code_info_reg.jsp?_code_type_=U'" class="btn pmd-ripple-effect btn-primary pmd-z-depth">상위코드 등록</button>
				<button type="button" onclick="location.href='code_info_reg.jsp?_code_type_=L'" class="btn pmd-ripple-effect btn-primary pmd-z-depth">하위코드 등록</button>
...
<%
		...
		try {
			...
			query += " where 1=1 and y.clm_delete_yn='N'";
			query += " order by cast(y.clm_code_id as numeric) asc ,cast(y.clm_code_sub_id as numeric) asc";

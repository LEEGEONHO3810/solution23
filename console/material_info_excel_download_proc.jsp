...
<%
		...
		try {
			...
			String int_clm_material_safety_stock = "";
			String float_clm_material_safety_stock = "";


			String[] headers = new String[] { "자재명", "자재 대분류", "자재 소분류", "자재 단위", "자재 안전재고","특이사항" };
			int[] headers_width = new int[] { 9000, 6000, 6000, 6000,5000,11000};
			...
			while (rs.next()) {
				...
				if(clm_material_safety_stock.contains(".")){
					String[] split_clm_material_safety_stock = clm_material_safety_stock.split("\\.");
					int_clm_material_safety_stock = split_clm_material_safety_stock[0];
					float_clm_material_safety_stock = split_clm_material_safety_stock[1];
				 }else{
					int_clm_material_safety_stock = clm_material_safety_stock;
				 }
				 System.out.println(int_clm_material_safety_stock);
				 clm_material_safety_stock = decFormat.format(Integer.parseInt(int_clm_material_safety_stock));


				 if(!float_clm_material_safety_stock.equals("")){

					clm_material_safety_stock = clm_material_safety_stock + "." + float_clm_material_safety_stock;

...
<!--tab start-->
    <div>
		...
		<div style="padding:2px; background-color:transparent; border:  1px solid transparent; box-shadow: none;">
		</div>
		<div>
			<!--section-title -- >
							...
							<table id="example" class="table pmd-table table-hover table-striped display responsive nowrap" cellspacing="0" width="100%">
								<tbody>
									...
									<tr>
										...
										<td style="text-align:center; padding:0px; padding-bottom:10px;"><span id="spn_work_process_01_date" name="spn_work_process_01_date" <% if(clm_work_process_01.equals("Y")){ %> style="background-color:red; color: white; font-weight:bold; padding:5px;"<% } %>><%=clm_work_process_01_date %></span></td>
										<td style="text-align:center; padding:0px; padding-bottom:10px;"><span id="spn_work_process_02_date" name="spn_work_process_02_date" <% if(clm_work_process_02.equals("Y")){ %> style="background-color:red; color: white; font-weight:bold; padding:5px;"<% } %>><%=clm_work_process_02_date %></span></td>
										<td style="text-align:center; padding:0px; padding-bottom:10px;"><span id="spn_work_process_03_date" name="spn_work_process_03_date" <% if(clm_work_process_03.equals("Y")){ %> style="background-color:red; color: white; font-weight:bold; padding:5px;"<% } %>><%=clm_work_process_03_date %></span></td>
										<td style="text-align:center; padding:0px; padding-bottom:10px;"><span id="spn_work_process_04_date" name="spn_work_process_04_date" <% if(clm_work_process_04.equals("Y")){ %> style="background-color:red; color: white; font-weight:bold; padding:5px;"<% } %>><%=clm_work_process_04_date %></span></td>
										<td style="text-align:center; padding:0px; padding-bottom:10px;"><span id="spn_work_process_05_date" name="spn_work_process_05_date" <% if(clm_work_process_05.equals("Y")){ %> style="background-color:red; color: white; font-weight:bold; padding:5px;"<% } %>><%=clm_work_process_05_date %></span></td>
										<td style="text-align:center; padding:0px; padding-bottom:10px;"><span id="spn_work_process_06_date" name="spn_work_process_06_date" <% if(clm_work_process_06.equals("Y")){ %> style="background-color:red; color: white; font-weight:bold; padding:5px;"<% } %>><%=clm_work_process_06_date %></span></td>
										<td style="text-align:center; padding:0px; padding-bottom:10px;"><span id="spn_work_process_07_date" name="spn_work_process_07_date" <% if(clm_work_process_07.equals("Y")){ %> style="background-color:red; color: white; font-weight:bold; padding:5px;"<% } %>><%=clm_work_process_07_date %></span></td>
										<td style="text-align:center; padding:0px; padding-bottom:10px;"><span id="spn_work_process_08_date" name="spn_work_process_08_date" <% if(clm_work_process_08.equals("Y")){ %> style="background-color:red; color: white; font-weight:bold; padding:5px;"<% } %>><%=clm_work_process_08_date %></span></td>
										<td style="text-align:center; padding:0px; padding-bottom:10px;"><span id="spn_work_process_09_date" name="spn_work_process_09_date" <% if(clm_work_process_09.equals("Y")){ %> style="background-color:red; color: white; font-weight:bold; padding:5px;"<% } %>><%=clm_work_process_09_date %></span></td>
										<td style="text-align:center; padding:0px; padding-bottom:10px;"><span id="spn_work_process_10_date" name="spn_work_process_10_date" <% if(clm_work_process_10.equals("Y")){ %> style="background-color:red; color: white; font-weight:bold; padding:5px;"<% } %>><%=clm_work_process_10_date %></span></td>
										<td style="text-align:center; padding:0px; padding-bottom:10px;"><span id="spn_work_process_11_date" name="spn_work_process_11_date" <% if(clm_work_process_11.equals("Y")){ %> style="background-color:red; color: white; font-weight:bold; padding:5px;"<% } %>><%=clm_work_process_11_date %></span></td>
									</tr>
									<tr>
										<td style="border-bottom: 1px solid white; text-align:center;"></td>
										<td style="border-bottom: 1px solid white; text-align:center;">
									...
									<tr>
										<td style="text-align:center; padding:0px; padding-bottom:10px;">실행</td>
										<td style="text-align:center; padding:0px; padding-bottom:10px;"><span id="spn_work_process_12_date" name="spn_work_process_12_date" <% if(clm_work_process_12.equals("Y")){ %> style="background-color:red; color: white; font-weight:bold; padding:5px;"<% } %>><%=clm_work_process_12_date %></span></td>
										<td style="text-align:center; padding:0px; padding-bottom:10px;"><span id="spn_work_process_13_date" name="spn_work_process_13_date" <% if(clm_work_process_13.equals("Y")){ %> style="background-color:red; color: white; font-weight:bold; padding:5px;"<% } %>><%=clm_work_process_13_date %></td>
										<td style="text-align:center; padding:0px; padding-bottom:10px;"><span id="spn_work_process_14_date" name="spn_work_process_14_date" <% if(clm_work_process_14.equals("Y")){ %> style="background-color:red; color: white; font-weight:bold; padding:5px;"<% } %>><%=clm_work_process_14_date %></td>
										<td style="text-align:center; padding:0px; padding-bottom:10px;"><span id="spn_work_process_15_date" name="spn_work_process_15_date" <% if(clm_work_process_15.equals("Y")){ %> style="background-color:red; color: white; font-weight:bold; padding:5px;"<% } %>><%=clm_work_process_15_date %></td>
										<td style="text-align:center; padding:0px; padding-bottom:10px;"><span id="spn_work_process_16_date" name="spn_work_process_16_date" <% if(clm_work_process_16.equals("Y")){ %> style="background-color:red; color: white; font-weight:bold; padding:5px;"<% } %>><%=clm_work_process_16_date %></td>
										<td style="text-align:center; padding:0px; padding-bottom:10px;"><span id="spn_work_process_17_date" name="spn_work_process_17_date" <% if(clm_work_process_17.equals("Y")){ %> style="background-color:red; color: white; font-weight:bold; padding:5px;"<% } %>><%=clm_work_process_17_date %></td>
										<td style="text-align:center; padding:0px; padding-bottom:10px;"><span id="spn_work_process_18_date" name="spn_work_process_18_date" <% if(clm_work_process_18.equals("Y")){ %> style="background-color:red; color: white; font-weight:bold; padding:5px;"<% } %>><%=clm_work_process_18_date %></td>
										<td style="text-align:center; padding:0px; padding-bottom:10px;"><span id="spn_work_process_19_date" name="spn_work_process_19_date" <% if(clm_work_process_19.equals("Y")){ %> style="background-color:red; color: white; font-weight:bold; padding:5px;"<% } %>><%=clm_work_process_19_date %></td>
										<td style="text-align:center; padding:0px; padding-bottom:10px;"><span id="spn_work_process_20_date" name="spn_work_process_20_date" <% if(clm_work_process_20.equals("Y")){ %> style="background-color:red; color: white; font-weight:bold; padding:5px;"<% } %>><%=clm_work_process_20_date %></td>
										<td style="text-align:center; padding:0px; padding-bottom:10px;"><span id="spn_work_process_21_date" name="spn_work_process_21_date" <% if(clm_work_process_21.equals("Y")){ %> style="background-color:red; color: white; font-weight:bold; padding:5px;"<% } %>><%=clm_work_process_21_date %></td>
										<td style="text-align:center; padding:0px; padding-bottom:10px;"><span id="spn_work_process_22_date" name="spn_work_process_22_date" <% if(clm_work_process_22.equals("Y")){ %> style="background-color:red; color: white; font-weight:bold; padding:5px;"<% } %>><%=clm_work_process_22_date %></td>
									</tr>
								</tbody>
							</table>
						</div>

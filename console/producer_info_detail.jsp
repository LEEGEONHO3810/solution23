...
<%
		...
		try {
			...
			query += " x.clm_reg_datetime, x.clm_update_user, x.clm_update_datetime, x.clm_user_seq, x.clm_del_yn,x.clm_producer_yn ";
		...
		<div class="table-responsive pmd-card pmd-z-depth">
			...
			<div class="pmd-card pmd-z-depth">
				<div class="pmd-card-body">
					<div class="group-fields clearfix row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="form-group pmd-textfield pmd-textfield-floating-label">
								...
								<input type="text" id="txt_notice_title" name="txt_notice_title" class="form-control" value="<%=clm_user_name %>" readOnly>
								<!--
					...
					<div class="group-fields clearfix row">
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
							<div class="form-group pmd-textfield pmd-textfield-floating-label">
								<label for="first-name">소속부서</label>
								<input type="text" class="mat-input form-control" id="txt_department_name" name="txt_department_name" value="<%=clm_department_name %>" readOnly>
								<input type="hidden" id="txt_department_id" name="txt_department_id" value="<%=clm_department_name %>" readOnly>
							</div>
						</div>
					</div>
				...
				<div class="pmd-card-actions">
					...
					-->
					<a href="producer_info_modify.jsp?_user_id_=<%=_user_id_ %>" class="btn btn-primary next" id="btn_save" name="btn_save">수정</a>
					<a href="product_info_list.jsp" class="btn btn-primary next" id="btn_list" name="btn_list">목록</a>
				</div>

...
<script type="text/javascript" language="javascript">
		...
		if(confirm('입고정보를 등록 하시겠습니까?')){
			...
			$.ajax({
				...
				success: function(args){
					alert("입고 등록완료");
					var material_income_id = '<%= clm_material_order_id %>';
					// $(location).attr("href", 'MaterialIncomeRegPopDetail.jsp?_material_income_id_='+material_income_id);
	...
	jQuery('#btn_model_info_reg').click(function(e){
		...
		appendTr += '<td style="padding:2px; border:1px solid #ccc; text-align:center;"><input type="button" style=" border:none;" class="btn btn-danger next" onClick="JavaScript:jQuery.income_material_del(\'' + seq_number + '\',\'\');" value="삭제" /></td>';
    ...
    <div class="container-fluid full-width-container value-added-detail-page">
		...
		<div class="table-responsive pmd-card pmd-z-depth">
			...
			<div class="pmd-card pmd-z-depth">
				<input type="hidden" id="txt_process_type" name="txt_process_type" class="form-control" value="R">
				<div class="pmd-card-body">
					<div class="group-fields clearfix row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<input type="hidden" class="mat-input form-control"  id="txt_material_order_id" value="" readonly>
						</div>
					</div>	
					<div class="group-fields clearfix row">
							...
							<table id="tbl_material_income_slave" class="table pmd-table table-hover table-striped display responsive nowrap" cellspacing="0" width="100%">
								<thead>
									<tr>
										...
										<th style="font-size:14px; text-align:center; font-weight:bold; border:1px solid #ccc; background-color: #eee !important; padding: 5px !important; width:120px;">자재 기준</th>
					...
					<div class="group-fields clearfix row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="form-group pmd-textfield pmd-textfield-floating-label">
								...
								<textarea required style="height: 150px;"  class="form-control" id="ta_comment" name="ta_comment"></textarea>
							</div>
						</div>
					</div>
				</div>
				<div class="pmd-card-actions">
					<a href="javascript:void(0);" class="btn btn-primary next" id="btn_material_income_reg" style="width: 53px;" name="btn_material_income_reg">저장</a>
					<a href="material_order_list.jsp?" class="btn btn-primary next" id="btn_list" style="width: 53px;" name="btn_list">취소</a>
				</div>

				...
				<table id="main_list" class="table table-striped table-bordered" style="width:100%">
					<thead>
						<tr>
							...
							<th style="border-top:5px solid #666; font-size:14px; font-weight:bold; text-align:center; width: 460px;">자재명</th>
								<th style="border-top:5px solid #666; font-size:14px; font-weight:bold; text-align:center; width: 150px;">자재 대분류</th>
								<th style="border-top:5px solid #666; font-size:14px; font-weight:bold; text-align:center; width: 150px;">자재 소분류</th>
								<th style="border-top:5px solid #666; font-size:14px; font-weight:bold; text-align:center; width: 145px;">자재 단위</th>
								<th style="border-top:5px solid #666; font-size:14px; font-weight:bold; text-align:center; width: 145px;">자재 안전재고</th>
								<th style="border-top:5px solid #666; font-size:14px; font-weight:bold; text-align:center; width: 145px;">자재 재고</th>
						</tr>
					</thead>
					<tbody>
<%
...
<script>
	...
	$.fnc_excel_download = function() {
		...
		if(arr_order_id==0) {
			$("#p_alert_msg").html("다운로드 할 자재 재고를 선택해 주십시요.");
			$('#div_alert_modal').modal("show");
			return 0;
		}
		...
		jQuery.ajax({
			url: 'material_stock_excel_download_proc.jsp',
			type:'POST',

    ...
    <div class="container-fluid full-width-container value-added-detail-page" >
		<div>
			<div class="pull-right table-title-top-action">
				...
				-->
				<button class="btn pmd-ripple-effect btn-primary pmd-z-depth" button type="button" onclick="location.href='product_info_reg.jsp'">등록</button>
				...
				<table id="main_list" class="table table-striped table-bordered" style="width:100%">
					<thead>
						<tr>
							...
							<th style="border-top:5px solid #666; font-size:14px; font-weight:bold; text-align:center;width:280px;">제품명</th>
								<th style="border-top:5px solid #666; font-size:14px; font-weight:bold; text-align:center; width:120px;">제품 대분류</th>
								<th style="border-top:5px solid #666; font-size:14px; font-weight:bold; text-align:center; width:120px;">제품 소분류</th>
								<th style="border-top:5px solid #666; font-size:14px; font-weight:bold; text-align:center; width:100px;">제품 규격</th>
								<th style="border-top:5px solid #666; font-size:14px; font-weight:bold; text-align:center; width:140px;">제품 안전 재고</th>
								<th style="border-top:5px solid #666; font-size:14px; font-weight:bold; text-align:center; width:80px;">제품 재고</th>
...
<%
		...
		try {
			...
			query += "  left outer join tbl_product_stock c on x.clm_product_id = c.clm_product_id  AND x.clm_company_key = c.clm_company_key  ";
...
%>
							<tr id="tr_<%=clm_product_id %>">
								...
								<td style="text-align: center;"><%=clm_product_name %></td>
								...
								<td style="font-size:14px; text-align:center;">
									<button type="button" class="btn btn-primary btn-sm" onClick="JavaScript:$.fnc_product_detail('<%=clm_product_id %>');" style="padding:2px;"> 상세 </button ></td>
							</tr>
<%
				iRowCnt++;
			}
...
$(document).ready(function() {
	...
	$.fnc_product_detail = function(product_id) {
		location.href='product_info_detail.jsp?_product_id_=' + product_id;
	}

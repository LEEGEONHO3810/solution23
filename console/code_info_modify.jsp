...
<%
		...
		try {
			...
			query += "x.* ";
			query += "from ";
			query += "	tbl_code_sub_info x ";
			query += "where 1=1 and x.clm_delete_yn='N' " + strCondition + " ";
			query += "order by x.clm_code_id, x.clm_code_sub_id desc;";
			...
			_code_type_ = (_code_sub_id_.equals("0000"))?"U":"L";
			...
			while (rs.next()) {
				...
				if(_code_type_.equals("L")) {
					clm_code_id			 = rs.getString("clm_code_id");
					clm_code_sub_id		 = rs.getString("clm_code_sub_id");
					clm_code_sub_value		 = rs.getString("clm_code_sub_value");
					clm_code_name		 = rs.getString("clm_code_name");
    ...
    <div class="container-fluid full-width-container value-added-detail-page">
		...
		<div class="table-responsive pmd-card pmd-z-depth">
			...
			<div class="pmd-card pmd-z-depth">
				<input type="hidden" id="txt_process_type" name="txt_process_type" class="form-control" value="L">
					...
					<div class="group-fields clearfix row">
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="form-group pmd-textfield pmd-textfield-floating-label">
								...
								<input type="text" id="txt_code_id" name="txt_code_id" class="form-control" value="<%=clm_code_id %>" data-param_01="" data-param_02="" data-toggle="modal" onClick="JavaScript:$.fnc_modal_cost_code(this);" readOnly>
							</div>
						</div>
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="form-group pmd-textfield pmd-textfield-floating-label">
								...
								<input type="text" id="txt_code_sub_id" name="txt_code_sub_id" class="form-control" value="<%=clm_code_sub_id %>" <% if(_code_type_.equals("U")){ %>readOnly style="background-color:#eee;"<% } %>>
							</div>
						</div>
					...
					<div class="group-fields clearfix row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="form-group pmd-textfield pmd-textfield-floating-label">
								...
								<textarea required class="form-control" id="ta_comment" name="ta_comment" <% if(_code_type_.equals("U")){ %>readOnly<% } %>><%=clm_comment %></textarea>
							</div>
						</div>
					</div>
...
<script>
	$(document).ready(function() {
		...
		$.fnc_select_to_parent_customer = function(customer_id, customer_name, customer_address, customer_employee_name, email, customer_tel, comment) {
			...
			$('input[name=txt_client_address]').val(customer_address);
			...
			if(customer_address!=''){ $('input[name=txt_client_address]').focus(); };
		...
		$.fnc_report_data_save = function() {
			...
			$.ajax({
				...
				success: function(result){
					...
					$(location).attr("href",'code_info_detail.jsp?_code_id_='+code_id+'&_code_sub_id_='+code_sub_id+'&_code_type_=L')
					loader.off();
				}
			});
		}
	...
	function sample2_execDaumPostcode() {
		new daum.Postcode({
			oncomplete: function(data) {
				...
				document.getElementById("txt_client_address").value = data.zonecode + ' ' + extraAddr + ' ' + addr;
				document.getElementById("txt_client_address").focus();
				// 커서를 상세주소 필드로 이동한다.

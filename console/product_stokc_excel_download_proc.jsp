...
<%
		...
		try {
			...
			String strCondition = "";
			strCondition += "and x.clm_product_id in (" + strOrderIdList + ") ";
			String query = "";
			...
			String[] headers = new String[] { "제품명", "제품 대분류", "제품 소분류", "제품 규격", "제품 안전재고", "제품 재고","특이사항"};
			int[] headers_width = new int[] { 9000, 6000, 6000, 6000,5000,5000,12000 };
			...
			while (rs.next()) {
				...
				cell.setCellValue(clm_product_main_type_name);
				cell.setCellStyle(Center_DataStyle);
				
				cell = row.createCell(2);
				cell.setCellValue(clm_product_sub_type_name);
				cell.setCellStyle(Center_DataStyle);
				
				cell = row.createCell(3);
				cell.setCellValue(clm_product_spec_name);
				cell.setCellStyle(Center_DataStyle);

				cell = row.createCell(4);
				cell.setCellValue(clm_product_safety_stock);

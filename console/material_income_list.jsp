		...
		<div>
			<div id="allPage">
				...
				<table id="main_list" class="table table-striped table-bordered" style="width:100%">
					<thead>
						<tr>
							<th style="font-size:14px; border-top:5px solid #666; text-align:center; font-weight:bold; width:4%;"><input type="checkbox" class="dt_all_chk" id="chk_all_order_id" name="chk_all_order_id" onClick="JavaScript:$.check_all();"></th>
							<th style="border-top:5px solid #666; font-size:14px; font-weight:bold; text-align:center;	width: 300px;">거래처</th>
...
<%
		...
		try {
			...
			query += " select x.clm_material_order_id , x.clm_client_id, y.clm_client_name , x.clm_order_date , x.clm_due_date, x.clm_all_income_yn , x.clm_comment,x.clm_reg_datetime ";
			...
			query += " order by x.clm_reg_datetime desc ";
...
<script>
	...
	$.fnc_excel_download = function() {
		...
		if(arr_order_id==0) {
			$("#p_alert_msg").html("다운로드 할 자재 입고 목록을 선택해 주십시요.");
			$('#div_alert_modal').modal("show");
			return 0;
		}

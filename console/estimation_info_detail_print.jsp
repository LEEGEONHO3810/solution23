...
<%
			...
			try {
				...
				while (rs.next()) {
					...
					String clm_work_process_01_date						 = (rs.getString("clm_work_process_01_date").equals(""))?"-":(rs.getString("clm_work_process_01_date")).substring(2);
					String clm_work_process_02_date						 = (rs.getString("clm_work_process_02_date").equals(""))?"-":(rs.getString("clm_work_process_02_date")).substring(2);
					String clm_work_process_03_date						 = (rs.getString("clm_work_process_03_date").equals(""))?"-":(rs.getString("clm_work_process_03_date")).substring(2);
					String clm_work_process_04_date						 = (rs.getString("clm_work_process_04_date").equals(""))?"-":(rs.getString("clm_work_process_04_date")).substring(2);
					String clm_work_process_05_date						 = (rs.getString("clm_work_process_05_date").equals(""))?"-":(rs.getString("clm_work_process_05_date")).substring(2);
					String clm_work_process_06_date						 = (rs.getString("clm_work_process_06_date").equals(""))?"-":(rs.getString("clm_work_process_06_date")).substring(2);
					String clm_work_process_07_date						 = (rs.getString("clm_work_process_07_date").equals(""))?"-":(rs.getString("clm_work_process_07_date")).substring(2);
					String clm_work_process_08_date						 = (rs.getString("clm_work_process_08_date").equals(""))?"-":(rs.getString("clm_work_process_08_date")).substring(2);
					String clm_work_process_09_date						 = (rs.getString("clm_work_process_09_date").equals(""))?"-":(rs.getString("clm_work_process_09_date")).substring(2);
					String clm_work_process_10_date						 = (rs.getString("clm_work_process_10_date").equals(""))?"-":(rs.getString("clm_work_process_10_date")).substring(2);
					String clm_work_process_11_date						 = (rs.getString("clm_work_process_11_date").equals(""))?"-":(rs.getString("clm_work_process_11_date")).substring(2);
					String clm_work_process_12_date						 = (rs.getString("clm_work_process_12_date").equals(""))?"-":(rs.getString("clm_work_process_12_date")).substring(2);
					String clm_work_process_13_date						 = (rs.getString("clm_work_process_13_date").equals(""))?"-":(rs.getString("clm_work_process_13_date")).substring(2);
					String clm_work_process_14_date						 = (rs.getString("clm_work_process_14_date").equals(""))?"-":(rs.getString("clm_work_process_14_date")).substring(2);
					String clm_work_process_15_date						 = (rs.getString("clm_work_process_15_date").equals(""))?"-":(rs.getString("clm_work_process_15_date")).substring(2);
					String clm_work_process_16_date						 = (rs.getString("clm_work_process_16_date").equals(""))?"-":(rs.getString("clm_work_process_16_date")).substring(2);
					String clm_work_process_17_date						 = (rs.getString("clm_work_process_17_date").equals(""))?"-":(rs.getString("clm_work_process_17_date")).substring(2);
					String clm_work_process_18_date						 = (rs.getString("clm_work_process_18_date").equals(""))?"-":(rs.getString("clm_work_process_18_date")).substring(2);
					String clm_work_process_19_date						 = (rs.getString("clm_work_process_19_date").equals(""))?"-":(rs.getString("clm_work_process_19_date")).substring(2);
					String clm_work_process_20_date						 = (rs.getString("clm_work_process_20_date").equals(""))?"-":(rs.getString("clm_work_process_20_date")).substring(2);
					String clm_work_process_21_date						 = (rs.getString("clm_work_process_21_date").equals(""))?"-":(rs.getString("clm_work_process_21_date")).substring(2);
					String clm_work_process_22_date						 = (rs.getString("clm_work_process_22_date").equals(""))?"-":(rs.getString("clm_work_process_22_date")).substring(2);
%>
							<table id="example" cellspacing="0" width="100%">
								<tbody>
									<tr>
										<td style="padding:5px; border:1px solid black;" width="9%">건축물해체허가신청기간</td>
										<td style="padding:5px; border:1px solid black;" width="9%">착공계제출</td>
										<td style="padding:5px; border:1px solid black;" width="9%">감리자계약</td>
										<td style="padding:5px; border:1px solid black;" width="9%">감리자지정</td>
										<td style="padding:5px; border:1px solid black;" width="9%">해체착공계제출</td>
										<td style="padding:5px; border:1px solid black;" width="9%">해체허가완료</td>
										<td style="padding:5px; border:1px solid black;" width="9%">비산먼지신고기간</td>
										<td style="padding:5px; border:1px solid black;" width="9%">비산먼지신고</td>
										<td style="padding:5px; border:1px solid black;" width="9%">특정공사신고</td>
										<td style="padding:5px; border:1px solid black;" width="9%">도로점용신고</td>
										<td style="padding:5px; border:1px solid black;" width="9%">건축물구조검토기간</td>
									</tr>
									<tr>
									...
									<tr>
										<td style="padding:5px; border:1px solid black;" width="9%">건축물구조검토완료</td>
										<td style="padding:5px; border:1px solid black;" width="9%">철거심의기간</td>
										<td style="padding:5px; border:1px solid black;" width="9%">철거심의완료</td>
										<td style="padding:5px; border:1px solid black;" width="9%">건설폐기물신고</td>
										<td style="padding:5px; border:1px solid black;" width="9%">석면신고기간</td>
										<td style="padding:5px; border:1px solid black;" width="9%">석면공사</td>
										<td style="padding:5px; border:1px solid black;" width="9%">해체완료</td>
										<td style="padding:5px; border:1px solid black;" width="9%">감리완료</td>
										<td style="padding:5px; border:1px solid black;" width="9%">멸실신고</td>
										<td style="padding:5px; border:1px solid black;" width="9%">등기정리</td>
										<td style="padding:5px; border:1px solid black;" width="9%">공사완료</td>
									</tr>
									<tr>

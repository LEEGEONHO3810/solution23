					...
					<thead>
						<tr>
							...
							<th style="border-top:5px solid #666; font-size:14px; font-weight:bold; text-align:center; width: 250px;">제품명</th>
								<th style="border-top:5px solid #666; font-size:14px; font-weight:bold; text-align:center; width: 140px;">제품 대분류</th>
								<th style="border-top:5px solid #666; font-size:14px; font-weight:bold; text-align:center; width: 140px;">제품 소분류</th>
								<th style="border-top:5px solid #666; font-size:14px; font-weight:bold; text-align:center; width: 120px;">제품 규격</th>
								<th style="border-top:5px solid #666; font-size:14px; font-weight:bold; text-align:center; width: 100px;">제품 안전 재고</th>

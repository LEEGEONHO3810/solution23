		...
		<div class="table-responsive pmd-card pmd-z-depth">
			...
			<div class="pmd-card pmd-z-depth">
				<div class="pmd-card-body">
					<div class="group-fields clearfix row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="form-group pmd-textfield pmd-textfield-floating-label">
								...
								<input type="text" id="txt_notice_title" name="txt_notice_title" class="form-control" value="<%=clm_notice_title %>" readOnly>
					...
					<div class="group-fields clearfix row">
						<div class="form-group pmd-textfield pmd-textfield-floating-label col-lg-4 col-md-4 col-sm-4 col-xs-12">
							<label for="first-name">공지시작일자</label>
							<input type="text" class="mat-input form-control" id="txt_notice_start_date" name="txt_notice_start_date" value="<%=clm_notice_start_date %>" readOnly>
						</div>
						<div class="form-group pmd-textfield pmd-textfield-floating-label col-lg-4 col-md-4 col-sm-4 col-xs-12">
							<label for="first-name">공지종료일자</label>
							<input type="text" class="mat-input form-control" id="txt_notice_end_date" name="txt_notice_end_date" value="<%=clm_notice_end_date %>" readOnly>
						</div>
						<div class="form-group pmd-textfield pmd-textfield-floating-label col-lg-4 col-md-4 col-sm-4 col-xs-12">
							<div class="form-group pmd-textfield pmd-textfield-floating-label">
								<label for="regular1" class="control-label">
								...
								<input type="text" id="txt_notice_type" name="txt_notice_type" value="<%=clm_notice_type_name %>" class="form-control" readOnly>
							</div>
						</div>
					</div>
					<div class="group-fields clearfix row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="form-group pmd-textfield pmd-textfield-floating-label">
								...
								<textarea required class="form-control" style="ta_notice_contents" name="ta_notice_contents" readOnly><%=clm_notice_contents %></textarea>
							</div>
						</div>
					</div>
				...
				<div class="pmd-card-actions">
					...
					-->
					<a href="notice_info_modify.jsp?_notice_id_=<%=_notice_id_ %>" class="btn btn-primary next" id="btn_save" name="btn_save">수정</a>
					<a href="notice_list.jsp" class="btn btn-primary next" id="btn_list" name="btn_list">목록</a>
				</div>

	...
	<script>
		$(document).ready(function() {
			$.fnc_select = function(code_id,sub_name,sub_id) {
				window.parent.$.fnc_select_to_parent_machine('<%=param_seq %>',code_id,sub_name,sub_id);
			}
		});
	</script>
...
<%
		...
		try { 
			...
			String modal_query = "select y.clm_code_sub_name,clm_code_sub_value,y.clm_code_id,y.clm_code_sub_id ";
				...
				modal_query += " left outer join tbl_code_sub_info y on x.clm_code_id = y.clm_code_id where 1=1 " + modal_strCondition + " ";
				modal_query += " and x.clm_company_key = '" + SessionCompanyKey + "' and y.clm_code_id ='0009' ";

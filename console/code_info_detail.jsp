...
<%
		...
		try {
			...
			query  = "";
			query += "select x.*  ";
			query += "  from tbl_code_sub_info x ";
			query += " where 1=1 and x.clm_delete_yn='N' and x.clm_code_sub_id <> '0000' " + strCondition + " ";
			...
			while (rs.next()) {
				...
				String clm_company_key		 = rs.getString("clm_code_id");
		...
		<div class="table-responsive pmd-card pmd-z-depth">
			...
			<div class="pmd-card pmd-z-depth">
					...
					<div class="group-fields clearfix row">
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="form-group pmd-textfield pmd-textfield-floating-label">
								...
								<input type="text" id="txt_code_id" name="txt_code_id" class="form-control" value="<%=clm_code_id %>" readOnly>
							</div>
						</div>
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="form-group pmd-textfield pmd-textfield-floating-label">
								...
								<input type="text" id="txt_code_sub_id" name="txt_code_sub_id" class="form-control" value="<%=clm_code_sub_id %>" readOnly>
							</div>
						</div>
					</div>
					<div class="group-fields clearfix row">
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="form-group pmd-textfield pmd-textfield-floating-label">
								...
								<input type="text" class="mat-input form-control" id="txt_code_sub_name" name="txt_code_sub_name" value="<%=clm_code_sub_name %>" readOnly>
							</div>
						</div>
					</div>
					<div class="group-fields clearfix row">
						<div class="form-group pmd-textfield pmd-textfield-floating-label col-lg-4 col-md-4 col-sm-4 col-xs-12">
							...
							<input type="text" class="mat-input form-control" id="txt_code_value" name="txt_code_value" value="<%=clm_code_sub_value %>" readOnly>
						</div>
					</div>
				...
				<div class="pmd-card-actions">
					...
					-->
					<a href="code_info_modify.jsp?_code_id_=<%=clm_code_id %>&_code_sub_id_=<%=clm_code_sub_id %>&_code_type_=L" class="btn btn-primary next" id="btn_save" name="btn_save">수정</a>
...
<script>
	$(document).ready(function() {
		...
		// 
		// $.fnc_add_comma($('input[name=txt_code_price]'));
		// $.fnc_add_comma($('#ifrm_cost_code_list'));

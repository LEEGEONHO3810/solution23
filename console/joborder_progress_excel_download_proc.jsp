...
<%
		...
		try {
			...
			String[] headers = new String[] { "작업지시서 번호", "제품명", "작업 예정일자", "작업 시작시간", "작업 종료시간","제작 개수","제작 된 개수","특이사항","작업 진행" };
			int[] headers_width = new int[] { 9000, 7000, 7000, 7000,7000,6000,6000,12000,6000};

...
jQuery('#btn_product_reg').click(function(e){
		...
		$.ajax({
			...
			success : function(data){
				console.log($('#txt_product_main_id option:selected').val());
				console.log($('#txt_product_sub_id option:selected').val());
				console.log($('#txt_product_name').val());
				alert("제품 정보 등록 완료");
				$(location).attr("href", 'product_stock_list.jsp?');
			}
		});
	});
				...
				<div class="pmd-card-body">
					<div class="group-fields clearfix row">
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
							...
							<input type="text" class="mat-input form-control" id="txt_product_name" name="txt_product_name" value="">
							</div>
						</div>
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
							<div id="preCode" class="form-group pmd-textfield pmd-textfield-floating-label">
								...
								<select id="txt_product_main_id" name="txt_product_main_id" class="select-simple form-control pmd-select2" style="background-color: #ffffff; width:100%; padding:5px;">
									<option <% if(clm_product_main_type_name.equals("")){ %> selected <% } %>>대분류 선택</option>
									<%
									try{
										stmt = conn.createStatement();
									...
									%>
										<option value="<%=clm_code_sub_id%>" <% if(clm_product_main_type_name.equals(clm_code_sub_id)){ %> selected <% } %>><%=clm_code_sub_name%></option>
									<%
										}
										stmt.close();
									} catch (Exception e) {
						...
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
							<div id="preCode" class="form-group pmd-textfield pmd-textfield-floating-label">
								...
								<select id="txt_product_sub_id" name="txt_product_sub_id"  class="select-simple form-control pmd-select2" style="background-color: #ffffff; width:100%; padding:5px;">
									<option  <% if(clm_product_sub_type_name.equals("")){ %> selected <% } %>>소분류 선택</option>
									<%
									try{
										stmt = conn.createStatement();
										...
										String	clm_code_sub_name = rs.getString("clm_code_sub_name");
									%>
										<option value="<%=clm_code_sub_id%>" <% if(clm_product_sub_type_name.equals(clm_code_sub_id)){ %> selected <% } %>><%=clm_code_sub_name%></option>
									<%
										}
										stmt.close();
									} catch (Exception e) {
					...
					<div class="group-fields clearfix row">
						...
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
							<div id="preproductName" class="form-group pmd-textfield pmd-textfield-floating-label">
								...
								<select id="txt_product_code_name" name="txt_product_code_name" class="select-simple form-control pmd-select2" style="background-color: #ffffff; width:100%; padding:5px;">
									<option <% if(clm_product_code_name.equals("")){ %> selected <% } %>>제품 코드 선택</option>
									<%
									try{
										stmt = conn.createStatement();
										...
										String	clm_code_sub_name = rs.getString("clm_code_sub_name");
									%>
										<option value="<%=clm_code_sub_id%>" <% if(clm_product_code_name.equals(clm_code_sub_id)){ %> selected <% } %>><%=clm_code_sub_name%></option>
									<%
										}
										stmt.close();
									} catch (Exception e) {
						...
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
							<div class="form-group pmd-textfield pmd-textfield-floating-label">
								...
								<input type="number" class="mat-input form-control" id="txt_clm_product_safety_stock" name="txt_clm_product_safety_stock" value="">
							</div>
						</div>
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
								<div class="form-group pmd-textfield pmd-textfield-floating-label">
									...
									<select id="txt_product_spec" name="txt_product_spec" class="select-simple form-control pmd-select2" style="background-color: #ffffff; width:100%; padding:5px;">
										<option <% if(clm_product_spec_name.equals("")){ %> selected <% } %>>제품 규격 선택</option>
										<%
										try{
											stmt = conn.createStatement();
											...
											String clm_code_sub_name = rs.getString("clm_code_sub_name");
										%>
											<option value="<%=clm_code_sub_id%>" <% if(clm_product_spec_name.equals(clm_code_sub_id)){ %> selected <% } %>><%=clm_code_sub_name%></option>
										<%
											}
											stmt.close();
											conn.close();

...
<%
		...
		try {
			...
			String query  = "";
			query  = "";
			query += " select x.clm_user_id, x.clm_user_pw, x.clm_user_name,x.clm_company_key,x.clm_user_authority,y.clm_department_id,x.clm_comment,x.clm_reg_user,y.clm_department_name, ";
			query += " x.clm_reg_datetime, x.clm_update_user, x.clm_update_datetime, x.clm_user_seq, x.clm_del_yn, z.clm_authority_id, z.clm_authority_name ";
					...
					<div class="group-fields clearfix row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="form-group pmd-textfield pmd-textfield-floating-label">
								...
								<input type="text" id="txt_user_name" name="txt_user_name" class="form-control" value="">
							</div>
						</div>
					</div>
					<div class="group-fields clearfix row">
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="form-group pmd-textfield pmd-textfield-floating-label">
								...
								<input type="text" id="txt_user_id" name="txt_user_id" class="form-control" value="">
							</div>
						</div>
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="form-group pmd-textfield pmd-textfield-floating-label">
								...
								<input type="password" id="txt_user_pw" name="txt_user_pw" class="form-control" value="">
							</div>
						</div>
					</div>
					<div class="group-fields clearfix row">
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
							<div class="form-group pmd-textfield pmd-textfield-floating-label">
								...
								<input type="text" class="mat-input form-control" id="txt_department_name" name="txt_department_name" value="" data-param_01="0" data-param_02="0003" data-toggle="modal" onClick="JavaScript:$.fnc_modal_department_code(this);" readOnly>
								<input type="hidden" id="txt_department_id" name="txt_department_id" value="">
							</div>
						</div>
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
							<div class="form-group pmd-textfield pmd-textfield-floating-label">
								권한<span style="font-weight:bold; color:red;">*</span>
								<input type="text" class="mat-input form-control" id="txt_authority_name" name="txt_authority_name" value="" data-param_01="0" data-param_02="0003" data-toggle="modal" onClick="JavaScript:$.fnc_modal_authority_code(this);" readOnly>
								<input type="hidden" id="txt_authority_id" name="txt_authority_id" value="" readOnly>
							</div>
						</div>
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" style="margin-top:25px;">
							<label class="pmd-checkbox checkbox-pmd-ripple-effect">
								<input type="checkbox" class="mat-input form-control" id="txt_producer_yn" name="txt_producer_yn" style="text-align: left;">
...
<script>
	$(document).ready(function() {
		$.fnc_chk_file_type = function(obj) {
		...
		$.fnc_report_data_save = function() {
			$.ajax({
				...
				success: function(result){
					...
					$(location).attr("href", 'user_list.jsp');
				}
			});
		}

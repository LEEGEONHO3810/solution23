		...
		<div class="table-responsive pmd-card pmd-z-depth">
			...
			<div class="pmd-card pmd-z-depth">
					...
					<div class="group-fields clearfix row">
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div id="preCode" class="form-group pmd-textfield pmd-textfield-floating-label">
								...
								<input type="text" id="txt_machine_type_name" value="<%= clm_machine_type_name %>" class="form-control" />
							</div>
						</div>
					</div>
					<div class="group-fields clearfix row">
				...
				<div class="pmd-card-actions">
					<a href="machine_info_modify.jsp?_machine_id_=<%= clm_machine_id %>" class="btn btn-primary next" id="btn_save" name="btn_save">수정</a>
					<a href="machine_info_list.jsp?" class="btn btn-primary next" id="btn_list" name="btn_list">뒤로</a>
				</div>

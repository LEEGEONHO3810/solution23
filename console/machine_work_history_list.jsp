    ...
    <div class="container-fluid full-width-container value-added-detail-page" >
		<div>
			<div class="pull-right table-title-top-action">
				...
				-->
				<button class="btn pmd-ripple-effect btn-primary pmd-z-depth" button type="button" onclick="location.href='joborder_info_reg.jsp'">등록</button>
				...
				<table id="main_list" class="table table-striped table-bordered" style="width:100%">
					<thead>
						<tr>
							...
							<th style="border-top:5px solid #666; font-size:14px; font-weight:bold; text-align:center;">작업지시서 번호</th>
							<th style="border-top:5px solid #666; font-size:14px; font-weight:bold; text-align:center;">제품명</th>
							<th style="border-top:5px solid #666; font-size:14px; font-weight:bold; text-align:center;">작업 예정 일자</th>
							<th style="border-top:5px solid #666; font-size:14px; font-weight:bold; text-align:center;">작업 예정 시작시간</th>
							<th style="border-top:5px solid #666; font-size:14px; font-weight:bold; text-align:center;">작업 예정 종료시간</th>
							<th style="border-top:5px solid #666; font-size:14px; font-weight:bold; text-align:center;">생산 개수</th>
...
<%
		...
		try {
			...
			//query += " left outer join tbl_machine_info c on x.clm_product_id = y.clm_product_id and x.clm_company_key = y.clm_company_key ";
...
%>
				<tr id="tr_<%=clm_joborder_id %>">
					...
					<td style="text-align: center;">
						<a href="javascript:location.href='joborder_info_detail.jsp?_joborder_id_=<%=clm_joborder_id %>';" style="color: #3366ff; font-weight:bold;" id="clm_joborder_id" ><%=clm_joborder_id %></a>
					</td>
					...
					<td style="text-align: center;"><%=clm_product_count %></td>

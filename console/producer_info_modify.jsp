		...
		<div class="table-responsive pmd-card pmd-z-depth">
			...
			<div class="pmd-card pmd-z-depth">
				...
				<div class="pmd-card-actions">
					...
					<a href="product_info_detail.jsp?_user_id_=<%=_user_id_ %>" class="btn btn-primary next" id="btn_list" name="btn_list">취소</a>
					<!--
		...
		$.fnc_report_data_save = function() {
			$.ajax({
				...
				success: function(result){
					...
					$(location).attr("href", 'producer_info_detail.jsp?_user_id_=<%=_user_id_ %>');
				}
			});
		}

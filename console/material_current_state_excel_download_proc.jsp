...
<%
		...
		try {
			...
			query += " where x.clm_company_key = '" + SessionCompanyKey + "' and y.clm_income_yn ='N' "+ strCondition +" ";
			...
			String[] headers = new String[] { "자재명", "자재 대분류", "자재 소분류", "자재 단위", "자재 안전재고", "자재 재고","입고 전 자재 수량" };
			int[] headers_width = new int[] { 9000, 6000, 6000, 6000,5000,3000,5000};

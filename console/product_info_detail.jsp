		...
		<div class="table-responsive pmd-card pmd-z-depth">
			...
			<form id="validationForm" action="" method="post" onsubmit="return false;">
				...
				<div class="pmd-card-body">
					<div class="group-fields clearfix row">
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
							...
							<input type="text" class="mat-input form-control" id="txt_product_name" name="txt_product_name" value="<%= clm_product_name %>" readOnly> 
							</div>
						</div>
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
							<div id="preCode" class="form-group pmd-textfield pmd-textfield-floating-label">
								...
								<input type="text" class="mat-input form-control" id="txt_product_main_type_name" name="txt_product_main_type_name" value="<%= clm_product_main_type_name %>" readOnly>
							</div>
						</div>
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
							<div id="preCode" class="form-group pmd-textfield pmd-textfield-floating-label">
								...
								<input type="text" class="mat-input form-control" id="txt_product_sub_type_name" name="txt_product_sub_type_name" value="<%= clm_product_sub_type_name %>" readOnly>
							</div>
						</div>
					...
					<div class="group-fields clearfix row">
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
							<div id="preproductName" class="form-group pmd-textfield pmd-textfield-floating-label">
								...
								<input type="text" class="mat-input form-control" id="txt_product_code_name" name="txt_product_name" value="<%= clm_product_code_name %>" readOnly>
							</div>
						</div>
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
							<div class="form-group pmd-textfield pmd-textfield-floating-label">
								...
								<input type="number" class="mat-input form-control" id="txt_clm_product_safety_stock" name="txt_clm_product_safety_stock" value="<%= clm_product_safety_stock %>" readOnly>
							</div>
						</div>
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
								<div class="form-group pmd-textfield pmd-textfield-floating-label">
									...
									<input type="text" class="mat-input form-control" id="txt_product_spec" name="txt_product_spec" value="<%= clm_product_spec_name %>" readOnly>
								</div>
							</div>
					</div>
					<div class="group-fields clearfix row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="form-group pmd-textfield pmd-textfield-floating-label">
								...
								<textarea type="text" class="mat-input form-control" id="ta_comment" name="ta_comment" value="<%= clm_comment %>" readOnly><%= clm_comment %></textarea>
							</div>
						</div>
					</div>
				...
				<div class="pmd-card-actions">
					...
					<a href="product_info_modify.jsp?_product_id_=<%= clm_product_id %>" class="btn btn-primary next" id="btn_save" name="btn_save">수정</a>

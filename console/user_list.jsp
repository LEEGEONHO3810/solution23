    ...
    <div class="container-fluid full-width-container value-added-detail-page" >
		<div>
			<div class="pull-right table-title-top-action">
				...
				-->
				<button class="btn pmd-ripple-effect btn-primary pmd-z-depth" button type="button" onclick="location.href='user_info_reg.jsp'">등록</button>
...
%>
							<tr id="tr_<%=clm_user_id %>">
								...
								<td style="font-size:14px; text-align:center;"><button type="button" class="btn btn-primary btn-sm" onClick="JavaScript:$.fnc_user_detail('<%=clm_user_id %>','<%= clm_producer_yn %>');" style="padding:2px;"> 상세 </button ></td>
							</tr>
<%
				iRowCnt++;
			}

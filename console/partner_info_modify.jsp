    ...
    <div class="container-fluid full-width-container value-added-detail-page">
		<div>
			...
			<ol class="breadcrumb text-left">
			  ...
			  <li class="active">업체 정보 관리</li>
			  <li class="active">업체 정보 수정</li>
			</ol><!--breadcrum end-->
		</div>
		...
		<div class="table-responsive pmd-card pmd-z-depth">
			...
			<div class="pmd-card pmd-z-depth">
				<div class="pmd-card-body">
					...
					<div class="group-fields clearfix row">
						<div class="form-group pmd-textfield pmd-textfield-floating-label col-lg-4 col-md-4 col-sm-4 col-xs-12">
							...
							<input type="text" class="mat-input form-control" id="txt_client_serial_no" name="txt_client_serial_no" value="<%=clm_client_serial_no %>" oninput="this.value = this.value.replace(/[^0-9,-]/g, '').replace(/(\..*)\./g, '$1');">
						</div>
						<div class="form-group pmd-textfield pmd-textfield-floating-label col-lg-4 col-m자d-4 col-sm-4 col-xs-12">
					...
					<div class="group-fields clearfix row">
						...
						<div class="form-group pmd-textfield pmd-textfield-floating-label col-lg-4 col-md-4 col-sm-4 col-xs-12">
							...
							<input type="text" class="mat-input form-control" id="txt_client_phone" name="txt_client_phone" value="<%=clm_client_phone %>">
						</div>
					</div>
					<div class="group-fields clearfix row">
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="form-group pmd-textfield pmd-textfield-floating-label">
								...
								<input type="text" id="txt_client_addr" name="txt_client_addr" class="form-control" style="cursor:pointer;" value="<%=clm_client_addr %>" readOnly onClick="JavaScript:sample2_execDaumPostcode();">
							</div>
						</div>
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="form-group pmd-textfield pmd-textfield-floating-label">
				...
				<div class="pmd-card-actions">
					...
					<a href="partner_info_detail.jsp?_customer_id_=<%=_customer_id_ %>" class="btn btn-primary next" id="btn_list" name="btn_list">취소</a>
					<!--

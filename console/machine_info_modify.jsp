...
<%
String machine_id = request.getParameter("_machine_id_") == null? "" : request.getParameter("_machine_id_");
...
try {
			...
			strCondition = "";
			String query =	"";
			query = " select x.clm_machine_id,x.clm_machine_name,x.clm_machine_type, coalesce(z1.clm_code_sub_name, '') as clm_machine_type_name,x.clm_company_key,x.clm_comment";
			...
			query += " where x.clm_company_key = '" + SessionCompanyKey + "' and x.clm_machine_id = '"+ machine_id +"' ";
		...
		<div class="table-responsive pmd-card pmd-z-depth">
			...
			<div class="pmd-card pmd-z-depth">
					...
					<div class="group-fields clearfix row">
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="form-group pmd-textfield pmd-textfield-floating-label">
								...
								<input type="text" id="txt_machine_name" value="<%= clm_machine_name %>" class="form-control" />
							</div>
						</div>
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div id="preCode" class="form-group pmd-textfield pmd-textfield-floating-label">
								...
								<input type="hidden" id="txt_machine_id"value="<%= clm_machine_id %>"/>
								<input type="text" id="txt_machine_type_name" class="mat-input form-control" value="<%= clm_machine_type_name %>" value="" data-param_01="0" data-param_02="0003" data-toggle="modal" onClick="JavaScript:$.fnc_modal_machine(this);" readonly>
							</div>
						</div>
					</div>
				...
				<div class="pmd-card-actions">
					...
					<a href="machine_info_list.jsp?" class="btn btn-primary next" id="btn_list" name="btn_list">목록</a>
				</div>

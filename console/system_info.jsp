...
<%
        ...
        String clm_user_id					 = "";
        String clm_user_pw					 = "";
        String clm_user_name				 = "";
        String clm_user_department_id		 = "";
        String clm_comment					 = "";
        String clm_reg_user					 = "";
        ...
        String clm_del_yn					 = "";
        String clm_flavor_operator_yn		 = "";
        String clm_user_alias				 = "";
        String clm_balance_type_a_ip		 = "";
        String clm_balance_type_b_ip		 = "";
        String clm_user_work_yn				 = "";
        String clm_user_authority			 = "";
        String clm_user_authority_screen	 = "";
        String clm_user_authority_button	 = "";
        String clm_phone_no					 = "";
        String clm_use_yn					 = "";
        String clm_user_seq					 = "";
        String clm_online_ip				 = "";
        String clm_user_img					 = "";
        String clm_user_tel					 = "";
        String clm_user_email				 = "";
        String clm_user_fax					 = "";
        String clm_department_name			 = "";
        String clm_user_serial_no			 = "";
        String clm_user_address				 = "";
        String clm_user_address_detail		 = "";
        String now_userId = session.getAttribute("user_id").toString();

        System.out.println(now_userId);
		...
		try {
			...
			query += "where x.clm_user_id = '"+ now_userId +"' and x.clm_del_yn='N' " + strCondition + "";
			...
			while (rs.next()) {
                ...
                clm_user_id		             = (rs.getString("clm_user_id")==null)?"":rs.getString("clm_user_id");
                clm_user_pw		             = (rs.getString("clm_user_pw")==null)?"":rs.getString("clm_user_pw");
				clm_department_name			 = (rs.getString("clm_department_name")==null)?"":rs.getString("clm_department_name");
				clm_user_img				 = (rs.getString("clm_user_img")==null)?"":rs.getString("clm_user_img");
				clm_user_name	             = (rs.getString("clm_user_name")==null)?"":rs.getString("clm_user_name");
				clm_user_department_id		 = (rs.getString("clm_user_department_id")==null)?"":rs.getString("clm_user_department_id");
                clm_comment					 = (rs.getString("clm_comment")==null)?"":rs.getString("clm_comment");
                clm_user_serial_no			 = (rs.getString("clm_user_serial_no")==null)?"":rs.getString("clm_user_serial_no");
                clm_user_seq				 = (rs.getString("clm_user_seq")==null)?"":rs.getString("clm_user_seq");
                clm_user_address			 = (rs.getString("clm_user_address")==null)?"":rs.getString("clm_user_address");
                clm_user_address_detail		 = (rs.getString("clm_user_address_detail")==null)?"":rs.getString("clm_user_address_detail");
                clm_user_tel				 = (rs.getString("clm_user_tel")==null)?"":rs.getString("clm_user_tel");
                clm_user_email				 = (rs.getString("clm_user_email")==null)?"":rs.getString("clm_user_email");
                clm_user_fax				 = (rs.getString("clm_user_fax")==null)?"":rs.getString("clm_user_fax");
			}
    ...
    <div class="container-fluid full-width-container value-added-detail-page">
			...
			<h1 class="section-title" id="services">
				<span class="avatar-list-img40x40">
					<%
						...
						System.out.println("> clm_user_img1 " + clm_user_img);
						clm_user_img = img_path + ((!clm_user_img.equals(""))?clm_user_img:"user_logo.png");
						System.out.println("> clm_user_img " + clm_user_img);
					%>
					<img alt="20x20" data-src="holder.js/20x20" class="img-responsive" src="<%= clm_user_img %>" data-holder-rendered="true">
				</span>
				<span>시스템 정보 수정</span>
			</h1><!-- End Title -->
			<!--breadcrum start-->
		...
		<div class="table-responsive pmd-card pmd-z-depth">
			...
			<div class="pmd-card pmd-z-depth">
				...
				<table id="tbl_report_item_info"
				class="table pmd-table table-bordered table-hover table-striped">
				<tbody>
					<tr>
						<td style="text-align:right; font-weight:bold; font-size: 16px; background-color: #D9EEFF; width: 15%;">아이디</td>
						<td colspan="2">
							<table style="width:100%; background-color: #EBECED;">
								<tr>
									<td style="width:100%; background-color: #EBECED;">
										<input type="hidden" id="txt_company_key" value="" />
										<input type="text" class="form-control" style="padding:5px; text-align: left;" value="<%=clm_user_id %>" id="txt_user_id" name="txt_user_id" readonly>
									</td>
								</tr>
							</table>
						</td>
						<td rowspan="4" style="text-align:right; font-weight:bold; font-size: 16px; background-color: #D9EEFF; width: 15%;">프로필 사진</td>
						<td rowspan="4" colspan="2">
							<div class="form-group pmd-textfield pmd-textfield-floating-label" style="text-align: left; padding-top: 10px; width:50%;">
								<input type="file" id="fl_user_img" name="fl_user_img" style="width:100%;"onchange="FileReady();" >
								<img class="proImage" id="img1" src="<%=clm_user_img%>" style="width: 200px; height: 200px;">
								<input type="hidden" id="img_check" value="">
							</div>
							<div class="form-group pmd-textfield pmd-textfield-floating-label" style="text-align: left;">
					...
					<tr>
						<td style="text-align:right; font-weight:bold; font-size: 16px; background-color: #D9EEFF; width: 15%;">성명</td>
						<td colspan="2">
							<table style="width:100%; background-color: #EBECED;">
								<tr>
									<td style="width:100%; background-color: #EBECED;">
										<input type="text" class="form-control" style="padding:5px; text-align: left;" value="<%=clm_user_name %>" id="txt_user_name" name="txt_user_name" >
									</td>
								</tr>
							</table>
						</td>
					...
					<tr>
						<td style="text-align:right; font-weight:bold; font-size: 16px; background-color: #D9EEFF; width: 15%;">비밀번호</td>
						<td colspan="2">
							<table style="width:100%; background-color: #EBECED;">
								<tr>
									<td style="width:100%; background-color: #EBECED;">
										<input type="password" class="form-control" style="padding:5px; text-align: left;" value="<%=clm_user_pw %>" id="txt_user_password" name="txt_user_pw">
									</td>
								</tr>
							</table>
						</td>
					...
					<tr>
						<td style="text-align:right; font-weight:bold; font-size: 16px; background-color: #D9EEFF; width: 15%;">주민등록번호</td>
						<td colspan="2">
							<table style="width:100%; background-color: #EBECED;">
								<tr>
									<td style="width:100%; background-color: #EBECED;">
										<input type="text" class="mat-input form-control" style="padding:5px; text-align: left;" id="txt_user_serial_no" name="txt_user_serial_no" value="<%=clm_user_serial_no %>" oninput="this.value = this.value.replace(/[^0-9,-]/g, '').replace(/(\..*)\./g, '$1');">
										<input type="hidden" id="txt_user_serial_no" name="txt_user_serial_no" value="<%=clm_user_serial_no %>">
									</td>
								</tr>
							</table>
						</td>
					...
					<tr>
						<td style="text-align:right; font-weight:bold; font-size: 16px; background-color: #D9EEFF; width: 15%;">부서</td>
						<td colspan="2">
							<table style="width:100%; background-color: #EBECED;">
								<tr>
									<td style="width:100%; background-color: #EBECED;">
										<input type="text" class="form-control" style="padding:5px; text-align: left;" value="<%=clm_department_name %>" id="txt_department_name"  name="txt_department_name" readonly>
										<input type="hidden" id="txt_department_id" name="txt_department_id" value="<%=clm_user_department_id %>">
									</td>
								</tr>
							</table>
						</td>
                        <td style="text-align:right; font-weight:bold; font-size: 16px; background-color: #D9EEFF; width: 15%;">전화번호</td>
						<td colspan="2">
							<table style="width:100%; background-color: #EBECED;">
								<tr>
									<td style="width:100%; background-color: #EBECED;">
							            <input type="text" class="form-control" style="width:100%; padding:5px; text-align: left;" id="txt_user_tel" name="txt_user_tel" oninput="this.value = this.value.replace(/[^0-9,-]/g, '').replace(/(\..*)\./g, '$1');" value="<%=clm_user_tel %>">
									</td>
								</tr>
							</table>
						</td>
					...
					<tr>
                        <td style="text-align:right; font-weight:bold; font-size: 16px; background-color: #D9EEFF; width: 15%;">주소</td>
						<td colspan="2">
							<table style="width:100%; background-color: #EBECED;">
								<tr>
									<td style="width:100%; background-color: #EBECED;">
										<input type="text" id="txt_user_address" name="txt_user_address" style="width:100%; padding:5px; text-align: left; cursor:pointer;" class="form-control" value="<%=clm_user_address %>" onClick="JavaScript:sample2_execDaumPostcode();">
									</td>
								</tr>
							</table>
						</td>
						<td style="text-align:right; font-weight:bold; font-size: 16px; background-color: #D9EEFF; width: 15%;">상세주소</td>
						<td colspan="4">
							<table style="width:100%; background-color: #EBECED;">
								<tr>
									<td style="width:100%; background-color: #EBECED;">
                                        <input type="text" id="txt_user_address_detail" style="width:100%; padding:5px; text-align: left;" name="txt_user_address_detail" class="form-control" value="<%=clm_user_address_detail %>">
									</td>
								</tr>
							</table>
						</td>
                    ...
                    <tr>
                        <td style="text-align:right; font-weight:bold; font-size: 16px; background-color: #D9EEFF; width: 15%;">팩스번호</td>
						<td colspan="2">
							<table style="width:100%; background-color: #EBECED;">
								<tr>
									<td style="width:100%; background-color: #EBECED;">
										<input type="text" class="mat-input form-control" id="txt_user_fax"  style="width:100%; padding:5px; text-align: left;" name="txt_user_fax" value="<%=clm_user_fax %>" oninput="this.value = this.value.replace(/[^0-9,-]/g, '').replace(/(\..*)\./g, '$1');">
									</td>
								</tr>
							</table>
						</td>
						<td style="text-align:right; font-weight:bold; font-size: 16px; background-color: #D9EEFF; width: 15%;">이메일</td>
						<td colspan="4">
							<table style="width:100%; background-color: #EBECED;">
								<tr>
									<td style="width:100%; background-color: #EBECED;">
                                        <input type="text" id="txt_user_email"  style="width:100%; padding:5px; text-align: left;" name="txt_user_email" class="form-control" value="<%=clm_user_email %>">
									</td>
								</tr>
							</table>
						</td>
                    ...
                    <tr>
                        <td style="text-align:right; font-weight:bold; font-size: 16px;   background-color: #D9EEFF; width: 15%;">특이사항</td>
						<td colspan="4">
							<table style="width:100%; background-color: #EBECED;">
								<tr>
									<td style="width:100%; background-color: #EBECED;">
                                        <textarea required class="form-control" style="width:100%; padding:5px; text-align: left;" name="ta_comment" ><%=clm_comment %></textarea>									</td>
								</tr>
							</table>
						</td>
                    </tr>
...
<script>
	$(document).ready(function() {
		...
		$.fnc_report_data_save = function() {
			...
			if ($("#txt_department_name").val() == '') {
				alert('소속부서를 선택해주시기 바랍니다.');
				return;
			}
			if ($("#txt_user_address").val() == '') {
				alert('주소를 입력해주시기 바랍니다.');
				return;
			}
			if ($("#txt_user_address_detail").val() == '') {
			...
			$.ajax({
				...
				success: function(result){
					...
					jQuery.ajax({
						url: 'file_upload_proc.jsp?order_id=' + user_id,
						data: form_data,
						contentType : false,
						processData : false,
						type:'POST',
						...
						success: function(result){
							...
							*/
							var input_file = $('input[name="fl_user_img"]');
							var form_data = new FormData();
							var seq_num = '00';
							for(var i=0; i<input_file.length; i++) {
								// console.log('> ' + i + ' ' + input_file[i].files.length);
		...
		$("#fl_user_img").on('change', function(event){
			...
			filesArr.forEach(function(f){
				...
				reader.onload = function(e) {
					...
					img.onload = function () {
						var imgWidth = img.width;//width 구하기
						var imgHeight = img.height;//height 구하기
		...
		if($('#fl_user_img').val() != ''){ // 내 PC 파일

		var File_full = $('#fl_user_img');
		var send_file = File_full[0].files;

		formData.append('imageFile',send_file[0]);
	...
	function sample2_execDaumPostcode() {
		new daum.Postcode({
			oncomplete: function(data) {
				...
				document.getElementById("txt_user_address").value = data.zonecode + ' ' + addr + ' ' + extraAddr;
				// 커서를 상세주소 필드로 이동한다.

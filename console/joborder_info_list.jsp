    ...
    <div class="container-fluid full-width-container value-added-detail-page" >
		<div>
			<div class="pull-right table-title-top-action">
				...
				-->
				<button class="btn btn-primary btn-sm" button type="button" onclick="location.href='joborder_info_reg.jsp'">등록</button>
				...
				<table id="main_list" class="table table-striped table-bordered" style="width:100%">
					<thead>
						<tr>
							...
							<th style="border-top:5px solid #666; font-size:14px; font-weight:bold; text-align:center; width: 180px;">작업지시서 번호</th>
							<th style="border-top:5px solid #666; font-size:14px; font-weight:bold; text-align:center; width: 160px;">제품명</th>
							<th style="border-top:5px solid #666; font-size:14px; font-weight:bold; text-align:center; width: 140px;">작업 예정 일자</th>
							<th style="border-top:5px solid #666; font-size:14px; font-weight:bold; text-align:center; width: 140px;">작업 시작시간</th>
							<th style="border-top:5px solid #666; font-size:14px; font-weight:bold; text-align:center; width: 140px;">작업 종료시간</th>
							<th style="border-top:5px solid #666; font-size:14px; font-weight:bold; text-align:center; width: 100px;">생산 개수</th>
...
%>
				<tr id="tr_<%=clm_joborder_id %>">
					...
					<td style="text-align: center;">
						<button type="button" class="btn btn-primary btn-sm" onClick="JavaScript:$.fnc_joborder_detail('<%=clm_joborder_id %>');" style="padding:2px;"> 상세 </button ></td>
					</td>
...
<script>
	...
	$.fnc_excel_download = function() {
		...
		jQuery.ajax({
			url: 'joborder_info_excel_download_proc.jsp',
			type:'POST',
	...
	$.fnc_joborder_detail = function(material_id) {
		location.href='joborder_info_detail.jsp?_joborder_id_=' + material_id;

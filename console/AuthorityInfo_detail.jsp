...
<%
		...
		try {
            ...
            query += "	        on y.clm_authority_id = x.clm_authority_id ";
            query += "  where 1=1 ";
            query += "	    and x.clm_authority_id = '"+ authority_id +"' ";
            query += "	    and x.clm_delete_yn != 'Y' ";
            System.out.println("> AuthorityInfo_detail.q.0 " + query);
		...
		<div class="table-responsive pmd-card pmd-z-depth">
			...
			<div class="pmd-card pmd-z-depth">
				<div class="pmd-card-body">
                    ...
                    <div class="group-fields clearfix row" style="overflow: auto; height: 330px;">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">

                            <div class="Aligner" style="width: 100%; height:300px; padding-top: 0px; padding-left: 0px; padding-right: 0px; display:flex;">
                                    ...
                                    <div style="width:100%; height:100%;">
                                        <div class="form-group pmd-textfield pmd-textfield-floating-label" style="width: 100%; height: 100%; float: left; padding-right: 10px;">
                                            <div id="tree">
                                                ...
                                                String plan_url = "jdbc:postgresql://itfactoryddns.iptime.org:5432/CHEONGJU_SOLUTION_2023";
                                ...
                                <div class="Aligner" style="width:calc(100% - 495px); height: 300px; padding-left: 0px; padding-right: 0px; background-color: white;">
                                    <div style="width: 100%; height:100%; text-align:center; margin-bottom: 30px; overflow: auto; height: 300px;">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				...
				<div class="pmd-card-actions">
					<a href="JavaScript:$.fnc_report_data_save();" class="btn btn-primary next">저장</a>
					<a href="AuthorityInfo.jsp" class="btn btn-primary next" id="btn_list" name="btn_list">목록</a>
				</div>

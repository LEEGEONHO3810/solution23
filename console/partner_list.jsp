...
<nav class="navbar navbar-inverse navbar-fixed-top pmd-navbar pmd-z-depth" style="border-color: <%=header_color %>; background-color: <%=header_color %>;">
	...
	<div class="container-fluid" style="background-color: <%=header_color %>;">
    ...
    <div class="container-fluid full-width-container value-added-detail-page">
		<div>
			<div class="pull-right table-title-top-action">
				...
				-->
				<button class="btn pmd-ripple-effect btn-primary pmd-z-depth" button type="button" onclick="location.href='partner_info_reg.jsp'">등록</button>
				...
				<table id="main_list" class="table table-striped table-bordered" style="width:100%; border-top:5px solid #666;">
					<thead>
						<tr>
							...
							<th style="font-size:14px; font-weight:bold; text-align:center;">업체명</th>
							<th style="font-size:14px; font-weight:bold; text-align:center;">대표자명</th>
							<th style="font-size:14px; font-weight:bold; text-align:center;">주소</th>
							<th style="font-size:14px; font-weight:bold; text-align:center;">연락처</th>
							<th style="font-size:14px; font-weight:bold; text-align:center;">FAX</th>
							<th style="font-size:14px; font-weight:bold; text-align:center;">Phone</th>
							<th style="font-size:14px; font-weight:bold; text-align:center;" width="60px">상세</th>
						</tr>
					</thead>
					<tbody>
<%
...
%>
							...
							<tr id="tr_<%=clm_client_id %>">
								<td class="td_first_child" style="text-align:center;">
									<input type="checkbox" class="dt_chk" id="chk_order_id" name="chk_order_id" value="<%=clm_client_id %>">
								</td>
								<td style="font-size:14px; text-align:left;"><%=clm_client_name %></td>
								...
								<td style="font-size:14px; text-align:center;"><button type="button" class="btn btn-primary btn-sm" onClick="JavaScript:$.fnc_partner_detail('<%=clm_client_id %>');" style="padding:2px;"> 상세 </button ></td>
							</tr>
<%
				iRowCnt++;
			}
...
$(document).ready(function() {
	...
	$.fnc_partner_detail = function(customer_id) {
		location.href='partner_info_detail.jsp?_customer_id_=' + customer_id;
	}
} );
</script>
<script>

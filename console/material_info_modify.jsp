...
<script type="text/javascript" language="javascript">
	...
	var material_name = '<%=clm_material_main_type_name %>';
	...
	jQuery('#btn_material_reg').click(function(e){
		...
		$.ajax({
			...
			data : { 
						...
						'material_code' : $('#txt_material_code_name option:selected').val(),
				   },
			type : "POST",
			dataType : "text",
			error : function() {
...
$(function(){
	$("#material_main_id").val("${param.sb_cate}").attr("selected","selected");
});
				...
				<div class="pmd-card-body">
					<div class="group-fields clearfix row">
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
							...
							<input type="text" class="mat-input form-control" id="txt_material_name" name="txt_material_name" value="<%=clm_material_name%>">
							</div>
						</div>
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
							<div id="preCode" class="form-group pmd-textfield pmd-textfield-floating-label">
								...
								<select id="txt_material_main_id" name="txt_material_main_id" class="select-simple form-control pmd-select2" style="background-color: #ffffff; width:100%; padding:5px;">
									<option  value="" <% if(clm_material_main_type.equals("")){ %> selected <% } %>>대분류 선택</option>
									<%
									try{
										stmt = conn.createStatement();
									...
									%>
										<option value="<%=clm_code_sub_id%>" <% if(clm_material_main_type.equals(clm_code_sub_id)){ %> selected <% } %>><%=clm_code_sub_name%></option>
									<%
										}
										stmt.close();
									} catch (Exception e) {
						...
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
							<div id="preCode" class="form-group pmd-textfield pmd-textfield-floating-label">
								...
								<select id="txt_material_sub_id" name="txt_material_sub_id"  class="select-simple form-control pmd-select2" style="background-color: #ffffff; width:100%; padding:5px;">
									<option value=""  <% if(clm_material_sub_type.equals("")){ %> selected <% } %>>소분류 선택</option>
									<%
									try{
										stmt = conn.createStatement();
										...
										while (rs.next()) {
											...
											clm_code_sub_name = rs.getString("clm_code_sub_name");
									%>
										<option value="<%=clm_code_sub_id%>" <% if(clm_material_sub_type.equals(clm_code_sub_id)){ %> selected <% } %>><%=clm_code_sub_name%></option>
									<%
										}
										stmt.close();
									} catch (Exception e) {
					...
					<div class="group-fields clearfix row">
						...
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
							<div id="preCode" class="form-group pmd-textfield pmd-textfield-floating-label">
								...
								<select id="txt_material_code_name" name="txt_material_code_name" class="select-simple form-control pmd-select2" style="background-color: #ffffff; width:100%; padding:5px;">
									<option value="" <% if(clm_material_code.equals("")){ %> selected <% } %>>자재코드 선택</option>
									<%
									try{
										stmt = conn.createStatement();
										...
										while (rs.next()) {
											...
											clm_code_sub_name = rs.getString("clm_code_sub_name");
									%>
										<option value="<%=clm_code_sub_id%>" <% if(clm_material_code.equals(clm_code_sub_id)){ %> selected <% } %>><%=clm_code_sub_name%></option>
									<%
										}
										stmt.close();
									} catch (Exception e) {
						...
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
							<div class="form-group pmd-textfield pmd-textfield-floating-label">
								...
								<input value="<%= clm_material_safety_stock %>" type="number" class="mat-input form-control" id="txt_clm_material_safety_stock" name="txt_clm_material_safety_stock" value="">
							</div>
						</div>
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
								<div class="form-group pmd-textfield pmd-textfield-floating-label">
									...
									<select id="txt_material_name_unit" name="txt_material_name_unit" class="select-simple form-control pmd-select2" style="background-color: #ffffff; width:100%; padding:5px;">
										<option value="" <% if(clm_material_unit.equals("")){ %> selected <% } %>>자재단위 선택</option>
										<%
										try{
											stmt = conn.createStatement();
											...
											clm_code_sub_name = rs.getString("clm_code_sub_name");
										%>
											<option value="<%=clm_code_sub_id%>" <% if(clm_material_unit.equals(clm_code_sub_id)){ %> selected <% } %>><%=clm_code_sub_name%></option>
										<%
											}
											stmt.close();
											conn.close();
